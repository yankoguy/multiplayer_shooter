...
class Camera(metaclass=Singleton):
    def __init__(self):
        self._camera_view = pg.Rect(0, 0, WINDOW_WIDTH, WINDOW_HEIGHT) # The part of the map that shown in screen
    ...
    def apply_pos(self, entity:object) -> pg.rect:
        """
        ...
        """
        return entity.rect.move(self._camera_view.topleft)
